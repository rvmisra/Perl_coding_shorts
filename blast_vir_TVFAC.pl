...
my $url = "http://www.tvfac.lanl.gov/cgi-bin/blast-ex.cgi";
...
open(OUTFILE, ">TVFAC1_blast_results_GENUS.html");
...
my $response = $browser->request(POST ($url, [DATALIB => "TVFacs", HITLIST_SIZE => "10",	
FILTER => "L", EXPECT => "0.0001", PROGRAM  => "blastp", SEQUENCE => $arrayOfSequences[$i], CMD => "Put"])); 	
...
print OUTFILE ("<b>********** Results for $arrayOfNames[$i].\n**************</b>");
print "\n";                                           
...
print "Open TVFAC1_blast_results_GENUS.html to view the results.\n";