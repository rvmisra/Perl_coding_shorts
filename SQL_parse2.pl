...
($pri_id_y,$line_id_y,$scanfile_y,$reference_y,$mh_y,$deltam_y,$z_y,$type_y,$peptide_seq_y,$sf_y,$xc_y,$deltacn_y,$sp_y,$rsp_y,$ions_y,$count_y,$accession_y) = split /\t/, $line;

#var_for_sql_script
#print OUTFILE "UPDATE genus_markers SET g_marker = 'N' WHERE pri_id = '$pri_id';\n";
print OUTFILE "INSERT INTO bioworks_y (pri_id_y,line_id_y, scanfile_y, reference_y, mh_y, deltam_y, z_y, type_y, peptide_seq_y, ppep_y, sf_y, xc_y, deltacn_y, sp_y, rsp_y, ions_y, count_y, accession_y) VALUES ('$pri_id_y','$line_id_y','$scanfile_y','$reference_y','$mh_y','$deltam_y','$z_y','$type_y','$peptide_seq_y','','$sf_y','$xc_y','$deltacn_y','$sp_y','$rsp_y','$ions_y','$count_y','$accession_y');\n";
