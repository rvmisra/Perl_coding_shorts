...
#counts it.
if ($sequenceEntry =~ m/ CDS /) {$count_CDS++}
...
print OUTFILE "Total number of *CDS* is *$count_CDS*\n";
print OUTFILE "Total number of *tRNA* is *$count_tRNA*\n";
print OUTFILE "Total number of *rRNA* is *$count_rRNA*\n";
