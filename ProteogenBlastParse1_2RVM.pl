...
#*********************************************************************************************
# FASTA header name
my $FASTAhead = "Clostridium_botulinum_NCTC8266_postNR";  #<--INPUT MARKER FASTA HEADER BETWEEN QUOTE MARKS
#*********************************************************************************************

#*********************************************************************************************
#Blastoutput > INPUT FILE NAME HERE
my $file1in = "C_botulinum_NCTC8266_rep2a_merge_tab_NR_vs_NCBI_50des_20al_2_output.txt"; #<-- INPUT BLAST FILE HERE
#*********************************************************************************************

#*********************************************************************************************
#SET SPECIES OF INTEREST: Between quote marks
my $Speciesofinterest = "Clostridium_botulinum"; #<--INPUT SPECIES OF INTEREST HERE
#*********************************************************************************************
...
if (($DD = $MM) && ($CC =~ /100/g) && ($BB !~ /$Speciesofinterest/gi)) {
