...
open(OUTFILE, ">NCBI_blast_results_UNIQUE_CUPID_test5.txt") or die ("Cannot open file : $!");
...
print "Open NCBI_blast_results_UNIQUE_CUPID_test5.txt to view the results.\n";
