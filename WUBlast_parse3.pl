...
open(OUTFILE, ">WUblast_parse_OUTPUT4.txt");
...
#if (($pcident > 85) && ($sid !~ /\Bacillus_/)){

if (($pcident =~ /100/) && ($sid !~ /\Burkholderia_pseudomallei/) && ($qgaps =~ /0/)){	
...
print "Output in the file: WUblast_parse_OUTPUT4.txt\n";