...
#prints to screen
print "The string '$word' is contained in the file '$fileToRead', $count times\n\n";
print " This will take $timeTaken_S seconds to analyase\n" ;
print " This will take $timeTaken_min minutes to analyase\n" ;
print " This will take $timeTaken_h hours to analyase\n\n" ;



#prints the final word count to file
