...
#*********************************************************************************************
# FASTA header name
my $FASTAhead = "SPECIES_NAME_HERE";  #<--INPUT MARKER FASTA HEADER BETWEEN QUOTE MARKS
#*********************************************************************************************

#*********************************************************************************************
#Blastoutput > INPUT FILE NAME HERE
my $file1in = "A2916_rep1_merge_tab_vs_NR_50des_20al_output.txt"; #<-- INPUT BLAST FILE HERE
#*********************************************************************************************
