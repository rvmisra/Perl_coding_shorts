...
open(OUTFILE, ">NCBI_blast_results_UNIQUE_CUPID_test3b.txt") or die ("Cannot open file : $!");
...
for (my $i = 0; $i < scalar(@arrayOfRID); $i = $i + 1) {
	...
	while ($resultFound == 0) {
		...
		my $result = $response->as_string();
		    ...
		    print "Writing the results to NCBI_blast_results_UNIQUE_CUPID_test3b.txt\n"; 
...
print "Open NCBI_blast_results_UNIQUE_CUPID_test3b.txt to view the results.\n";
