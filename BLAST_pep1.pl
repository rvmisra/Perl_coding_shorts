...
for (my $i = 0; $i < scalar(@arrayOfSequences); $i = $i + 1) {
    ...
    FILTER => "L", PROGRAM  => "blastp", EXPECT => "0.0001", MATRIX_NAME => "PAM30", 
...
open(OUTFILE, ">NCBI_blast_results_BLASTPEP1.txt") or die ("Cannot open file : $!");
...
print "Open NCBI_blast_results_BLASTPEP1.txt to view the results.\n";
