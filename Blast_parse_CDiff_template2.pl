...
open(OUTFILE, ">Clost_extraction_peps_to_remove2.txt");
...
if (($percent_id =~ /100/) && ($subject !~ /Clostridium_difficile/)  && ($alignment_length > 7)) {

print OUTFILE "$query" . "_" . "$alignment_length" . "\n";
