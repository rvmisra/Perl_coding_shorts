...
for (my $i = 0; $i < scalar(@arrayOfSequences); $i = $i + 1) {
    ...
    FILTER => "L", PROGRAM  => "blastp", EXPECT => "50000", GAPCOSTS => "10 1", MATRIX_NAME => "PAM30", 
...
open(OUTFILE, ">NCBI_blast_results1_blast_pl.txt") or die ("Cannot open file : $!");
...
print "Open NCBI_blast_results1_blast_pl.txt to view the results.\n";
