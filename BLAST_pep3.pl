...
open(OUTFILE, ">NCBI_blast_result_PEP_search_FROM_BLAST_pep3.txt") or die ("Cannot open file : $!");
...
print "Open NCBI_blast_result_PEP_search_FROM_BLAST_pep3.txt to view the results.\n";
